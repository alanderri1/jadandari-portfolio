...
// title and description are copied verbatim; rows with no description in
// the sheet are left with description: '' (intentionally, not filled in).
//
// HOW TO EXTEND:
...
export const portraits = [
  ...
  { id: 'painting-01', title: 'untitled', image: img1, description: '' },
  ...
  { id: 'painting-05', title: 'untitled', image: img5, description: '' },
  { id: 'painting-07', title: 'untitled', image: img7, description: 'oil on paper, 42 x 30 cm' },
  { id: 'painting-09', title: 'untitled', image: img9, description: 'oil on wood' },
]
