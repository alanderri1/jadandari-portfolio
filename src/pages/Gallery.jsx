...
export default function Gallery() {
  ...
  return (
    <div className="pt-32 pb-24 px-5 sm:px-10 max-w-7xl mx-auto">
      <Reveal>
        <p className="text-xs sm:text-sm tracking-[0.3em] uppercase text-crimson mb-3">Portfolio</p>
        <h1 className="font-display italic text-5xl sm:text-6xl mb-4">The Gallery</h1>
      ...
      <BrushDivider color="ochre" className="mb-10 opacity-70" />
          ...
          <button
            ...
            className={`relative px-5 py-2 text-sm uppercase tracking-[0.15em] rounded-full border transition-colors ${
              activeCategory === cat
                ...
                : 'border-ink/25 text-ink/60 hover:border-crimson hover:text-crimson'
            }`}
          >
            {cat}
          </button>
